    ...
    const initialContent = [
      {
        ...
        content: {
          ...
          description: 'Experience premium luxury apartments with world-class amenities and strategic location.'
        }
      },
      {
        ...
        content: {
          title: 'Project Overview',
          description: 'MegaPrime Residency is a premium residential project offering luxurious 2BHK and 3BHK apartments with modern amenities and excellent connectivity.'
        }
      },
      {
      ...
      },
      {
        ...
        content: {
          ...
          amenities: [
            { name: 'Swimming Pool', description: 'Olympic-size swimming pool for residents' },
            { name: 'Gymnasium', description: 'Fully equipped modern fitness center' },
            { name: 'Club House', description: 'Premium club house with recreational facilities' },
            { name: 'Children\'s Play Area', description: 'Safe and fun play area for kids' },
            { name: 'Garden & Landscaping', description: 'Beautifully landscaped gardens' },
      ...
      },
      {
        ...
        content: {
          ...
          description: 'We are a premier real estate development company committed to delivering excellence in luxury residential projects with sustainable and innovative solutions.'
        }
      },
      {
        ...
        content: {
          ...
          questions: [
            ...
            },
            {
              ...
              answer: 'We offer 2BHK apartments (1200 sq.ft) and 3BHK apartments (1800 sq.ft).'
            },
            {
            ...
            },
            {
              ...
              answer: 'Yes, we offer flexible rental options for interested buyers.'
            }
          ]
        }
      }
